...
pdf(file="Sft1e7_manplot.pdf",family="sans",height=27.8,width=50,pointsize=20,bg="white")
par(mfrow=c(1,1),family="sans",cex=1.5,font=2)
plot(y,x,xaxt="n",main="Manhattan Plot SNP Solution - Trait: 1 Effect: 7",xlab="",ylab="SNP solution   ",pch=20,xlim=c(1,n),ylim=c(0,max(x)),col=chr)
