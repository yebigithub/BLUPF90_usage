...
pdf(file="Pft1e8_manplot.pdf",family="sans",height=27.8,width=50,pointsize=20,bg="white")
par(mfrow=c(1,1),family="sans",cex=1.5,font=2)
plot(y,x,xaxt="n",main="Manhattan Plot SNP p_value - Trait: 1 Effect: 8",xlab="",ylab="-log10(p-value)",pch=20,xlim=c(1,n),ylim=c(0,max(x)),col=chr)
