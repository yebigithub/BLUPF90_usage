...
zzz  = yyy[ which(yyy$V1==1 & yyy$V2==9), ]
n    = nrow(zzz)
y    = zzz[,4]
x    = zzz[,3]
chr1 = zzz[,5]
...
pdf(file="Sft1e9_manplot.pdf",family="sans",height=27.8,width=50,pointsize=20,bg="white")
par(mfrow=c(1,1),family="sans",cex=1.5,font=2)
plot(y,x,xaxt="n",main="Manhattan Plot SNP Solution - Trait: 1 Effect: 9",xlab="",ylab="SNP solution   ",pch=20,xlim=c(1,n),ylim=c(0,max(x)),col=chr)
